          ...
          <div className="flex gap-20">
            ...
            <div className="pr-20">
              ...
              <div className={styles.card2}>
                ...
                <ol type="1">
                  <li>
                    1. Note at any point in time. you can always save and
                    continue later{" "}
                  </li>
                  <li>
                    2. Note at any point in time. you can always save and
                    continue later{" "}
                  </li>
                  <li>
                    3. Note at any point in time. you can always save and
                    continue later{" "}
                  </li>
                  <li>
                    4. Note at any point in time. you can always save and
                    continue later{" "}
                  </li>
                </ol>
              </div>
