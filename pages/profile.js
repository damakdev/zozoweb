				...
				<div className="flex justify-between">
					...
					<div className={`${styles.profile_bar} bg-white h-2/3 w-8/12`}>
						<ul className="flex  ">
								...
								<li onClick={()=>setProfileTab("loginDetails")}  className="flex items-center  py-5 mr-10 pl-10">
									<Plus className="mr-8" />
									Log activity
								</li>
								...
								<li onClick={()=>setProfileTab("reminder")} className="flex items-center  py-5 mr-10 pl-10">
								...
								<li  onClick={()=>setProfileTab("link")} className="flex items-center  py-5 mr-10 pl-10">
